...
products_storage= [{"price":19.0,"name":"House & Home Hooded
Blanket - Charcoal","id":"671282","position":1,"list":"Product
Category - Level 2","category":"Home/Bedding/Blankets","brand":"House
& Home"},{"price":5.0,"name":"House & Home 225TC Pillowcase - Dance
All Night - White","id":"649566","position":2,"list":"Product Category
- Level 2","category":"Home/Bedding/Pillow Cases","brand":"House &
Home"},{"price":59.0,"name":"House & Home Linen Cotton Quilt Cover Set
- Frayed Edge - Charcoal -
Queen","id":"659975","position":3,"list":"Product Category - Level
2","category":"Home/Bedding/Quilt Covers"},{"price":59.0,"name":"House
& Home Linen Cotton Quilt Cover Set - Frayed Edge - Navy -
...
Home"},{"price":25.0,"name":"House & Home Melange Plush Blanket - Grey
Blue - Queen","id":"656994","position":7,"list":"Product Category -
Level 2","category":"Home/Bedding/Blankets","brand":"House &
...
Coverlet - Queen","id":"660111","position":17,"list":"Product Category
- Level 2","category":"Home/Bedding/Quilt Covers","brand":"House &
Home"},{"price":9.0,"name":"Smart Value Quilt Cover Set - Iron Gate -
...
import json
import re
product_storage_parsed = re.search('\[{.*}\]', product_storage_string_raw, 
...
assert type(product_storage_json) == list
product_storage_json = json.dumps(product_storage_json)
assert type(product_storage_json) == str